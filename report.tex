...
\end{align*}
  ...
  \newpage
  \section{Simulation}
  \includegraphics[scale=0.5]{sim_plot1}
  \includegraphics[scale=0.5]{sim_plot2}

  \newpage
  \section{Waveforms}
  \includegraphics[scale=0.5]{results_q1}
  \includegraphics[scale=0.5]{results_q3}
  \includegraphics[scale=0.5]{results_q4_2}
