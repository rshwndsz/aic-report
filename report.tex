...
\begin{document}
  ...
  \section{Circuit diagram}
    \begin{figure}[h]
      ...
      % TODO Add better caption that is not repeating the section heading
  ...
  \section{Theory}
    ...
    %===Practical opamp integrator===
    One can overcome the limitations of an ideal integrator by adding a resistor $R_{f}$ in parallel with capacitor $C$ as shown in figure \ref{fig:theoretical_practical_integrator}. $R_{f}$ prevents the opamp from going into open loop configuration at low frequencies.
    ...
    %===Advantages of practical over ideal===
  ...
  \section{Simulation}
    ...
    \includegraphics[width=\textwidth]{sim_circuit}
    \includegraphics[width=\textwidth]{sim_plot_fd}
    \includegraphics[width=\textwidth]{sim_plot_td}
